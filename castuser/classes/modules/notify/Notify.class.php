...
class PluginCastuser_ModuleNotify extends PluginCastuser_Inherit_ModuleNotify
{
     ...
     * @param string $sText
     */
    public function SendCastedNotify(ModuleUser_EntityUser $oUserTo, ModuleUser_EntityUser $oUserFrom, $sText, $sTitle)
    {
        /**
